...
module Conversion
  module Steps
    class XSweetDocxToHtmlHandleNotes < ConversionStep
      ...
      def convert_file(incoming_html_file, options_hash = {})
        ...
        apply_xslt_transformation(file_path: incoming_html_file,
      ...
      def xsl_file
        File.join(xsl_working_directory, "handle-notes.xsl")
      end

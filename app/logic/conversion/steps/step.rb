...
module Conversion
  module Steps
    class Step
      ...
      # def input_filename(input_file)
      #   puts "input_filename start"
      #   return input_file.file.file if input_file.is_a? CarrierWave::SanitizedFile
      #   return input_file.file.file if input_file.is_a? Rack::Test::UploadedFile

...
class ExecutionWorker
  ...
  def perform(chain_id, callback_url)
    ...
    begin
      ...
      ap e.message
      ap e.backtrace
      trigger_event(channels: execution_channel, event: process_chain_error_event, data: { recipe_id: @process_chain.recipe_id, chain_id: chain_id, output_file_manifest: @process_chain.output_file_manifest})
    ensure
